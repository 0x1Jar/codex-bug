...
#
# Usage:
#   chmod +x modules/orchestrator/h1_run.sh
#   ./modules/orchestrator/h1_run.sh
...
TOOLS_DIR="$ROOT_DIR/modules/scanners"
if [[ ! -d "$TOOLS_DIR" ]]; then
  TOOLS_DIR="$ROOT_DIR"
fi

FINDINGS_DIR="$ROOT_DIR/findings/hackerone"
...
echo "  [ ] 2FA rate limit — run: python3 modules/scanners/h1_race.py --token-a TOKEN_B --test 2fa"
