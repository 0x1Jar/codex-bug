...
Usage:
  python3 learn.py --tech "nextjs,graphql"
  python3 learn.py --tech "nextjs,graphql" --target target.com --output recon/target.com/intel.md
  python3 learn.py --tech "solidity" --hackerone-program target-program
"""
...
def main():
    ...
    if args.output:
        ...
        base_dir = os.path.join(BASE_DIR, "recon", args.target)
