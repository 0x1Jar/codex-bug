...
Usage:
  python3 mindmap.py --target target.com --type opensrc --tech "nextjs,graphql,solidity"
  python3 mindmap.py --target example.com --type website --tech "nginx,react"
  python3 mindmap.py --target api.example.com --type api --tech "jwt,openapi"
"""
...
def main():
    ...
    if args.output:
        ...
        base_dir = os.path.join(BASE_DIR, "findings", target)
